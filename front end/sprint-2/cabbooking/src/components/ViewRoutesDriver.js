...
const useStyles = makeStyles({
 ...
 function ViewRoutesDriver() {
    const classes = useStyles();
  
    return (
        <div style={{borderRadius: '5px',marginTop:'8%', marginLeft:'25%', marginRight:'25%',paddingTop:'1.5%',paddingBottom:'1.5%'}} align="center">
      ...
      <NavLink to="/driverFunctions" style={{cursor:'pointer',textDecoration: 'none'}}><Button 
  variant="contained" 
  color="primary" 
...
export default ViewRoutesDriver
